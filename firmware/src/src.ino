...
// CT1 --------------------------------------------------------------------------------------------------------------
  if ( (ct==1) && (analogRead(1) > 0)){                                                         // If CT is plugged in then sample
    if (ACAC)
    {
      ...
      // emonPi[sample_count] = ct1.realPower * 100;
      power1 = ct1.realPower * 100;
    }
